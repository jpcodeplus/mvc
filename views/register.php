  ...
  <div
    ...
    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
      ...
      <form class="space-y-4 md:space-y-6" method="POST">
        ...
        <p class="text-sm font-light text-gray-500 dark:text-gray-400">Schon regestriert? <a
            class="font-medium text-blue-600 hover:underline dark:text-blue-500" href="/signin">Hier Anmelden</a>
        </p>
      </form>
    </div>
  </div>
