...
<body>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-1 w-screen max-w-screen-xl mx-auto p-4 bg-gray-100">
            {{ content }}
        </main>
                ...
                <div class="md:flex md:justify-between">
                    <div class="mb-6 md:mb-0">
                        <a href="/" class="flex items-center">
                            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white/60"><?= $company["name"]; ?></span>
                        </a>
                    </div>
